...
const SignIn: React.FC = () => {
  ...
  return (
    <>
      ...
      <div className="w-full rounded-sm border border-stroke bg-black shadow-default dark:border-strokedark dark:bg-boxdark">
            ...
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              ...
              <>
                ...
                <form
                  onSubmit={async (e) => {
                    e.preventDefault();
                    await clientPb.collection("users").authWithOAuth2({
                      provider: "google",
                    });
                    setCookie("pb_auth", clientPb.authStore.exportToCookie());
                    router.refresh();
                  }}
                >
                  <button
